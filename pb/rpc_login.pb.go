...
type LoginResponse struct {
	...
	RefreshToke           string                 `protobuf:"bytes,4,opt,name=refresh_toke,json=refreshToke,proto3" json:"refresh_toke,omitempty"`
...
func (x *LoginResponse) GetRefreshToke() string {
	if x != nil {
		return x.RefreshToke
	}
	return ""
}
...
const file_rpc_login_proto_rawDesc = "" +
	"\n" +
	"\x0frpc_login.proto\x12\x02pb\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\n" +
	"user.proto\"G\n" +
	...
	"\frefresh_toke\x18\x04 \x01(\tR\vrefreshToke\x12S\n" +
	"\x18refresh_token_expires_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\x15refreshTokenExpiresAt\x12\x1c\n" +
	"\x04user\x18\x06 \x01(\v2\b.pb.UserR\x04userB*Z(github.com/BinayRajbanshi/GoBasicBank/pbb\x06proto3"
